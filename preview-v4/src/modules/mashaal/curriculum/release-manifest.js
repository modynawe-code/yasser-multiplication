...
export const MASHAAL_KG3_RELEASE_MANIFEST = Object.freeze({
  ...
  quranIslamicContent:Object.freeze({status:'verified-with-media-blocker',sourceId:SELS,readySkills:1,blockedSkills:1,blocker:'approved-human-recitation-audio'}),
