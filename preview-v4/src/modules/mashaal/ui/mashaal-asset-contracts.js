...
const CONTRACTS=Object.freeze({
  ...
  'girl-drinking-water':illustratedScene('child-drinking-water'),'girl-lost-toy':wholeScene('lost-toy-emotion'),'rainy-day':wholeScene('rain-context'),
  ...
  'help-tidy':illustratedScene('helping-tidy'),'leave-mess':illustratedScene('leaving-mess'),'scatter-toys':illustratedScene('scattering-toys'),
  wake:illustratedScene('wake-up'),'brush-teeth':illustratedScene('brushing-teeth'),breakfast:illustratedScene('eating-breakfast'),
  ...
  'fine-motor':Object.freeze({role:'guided-action',fit:'cover',position:'50% 50%',semanticFocus:'transfer-three-safe-pieces',renderMode:'media',cropScale:1})
});
