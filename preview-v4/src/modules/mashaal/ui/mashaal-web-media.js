...
export const MASHAAL_WEB_MEDIA=Object.freeze({
  ...
  doctor:Object.freeze({url:'https://upload.wikimedia.org/wikipedia/commons/thumb/3/3c/Doctor.svg/960px-Doctor.svg.png',altAr:'طبيبة',source:'Wikimedia Commons / Openclipart',license:'CC0 1.0'}),
  teacher:Object.freeze({url:'https://upload.wikimedia.org/wikipedia/commons/thumb/b/be/Teacher_icon.svg/960px-Teacher_icon.svg.png',altAr:'معلمة',source:'Wikimedia Commons / Openclipart',license:'CC0 1.0'}),
  baker:Object.freeze({url:'https://upload.wikimedia.org/wikipedia/commons/thumb/4/4c/Baker.svg/1920px-Baker.svg.png',altAr:'خباز',source:'Wikimedia Commons / Openclipart',license:'CC0 1.0'}),
