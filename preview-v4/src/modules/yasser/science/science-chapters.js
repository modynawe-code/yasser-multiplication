export const YASSER_SCIENCE_CHAPTERS=Object.freeze([
  ...
  Object.freeze({id:'chapter-5-ecosystems',label:'الفصل 5: الأنظمة البيئية',shortLabel:'الأنظمة البيئية',unitIds:Object.freeze(['food-relations','ecosystems'])}),
  Object.freeze({id:'chapter-6-earth-resources',label:'الفصل 6: موارد الأرض والحفاظ عليها',shortLabel:'موارد الأرض والحفاظ عليها',unitIds:Object.freeze(['earth-resources','resource-protection'])})
]);
...
export const DEFAULT_YASSER_SCIENCE_UNIT_ID='unit-3-ecosystems-resources';
...
export function getScienceUnit(unitId=DEFAULT_YASSER_SCIENCE_UNIT_ID){return YASSER_SCIENCE_UNITS.find(unit=>unit.id===unitId)||YASSER_SCIENCE_UNITS.find(unit=>unit.id===DEFAULT_YASSER_SCIENCE_UNIT_ID)||YASSER_SCIENCE_UNITS[0];}
