...
export const KHALED_SKILLS=Object.freeze([
  {
    ...
    lessons:['التصنيف وفق خاصية واحدة','التصنيف وفق أكثر من خاصية','يساوي','أكثر من وأقل من'],
  ...
  },
  {
    ...
    chapter:2,
    title:'الأعداد حتى 5',
    shortTitle:'0 إلى 5 • عد وقراءة',
    symbol:'5',
    status:'ready',
    activityTypes:['count-select','spoken-number-select'],
    lessons:['الأعداد 1،2،3','قراءة الأعداد 1،2،3 وكتابتها','العددان 4،5','قراءة العددين 4،5 وكتابتهما','أحل المسألة: أرسم صورة','قراءة العدد صفر وكتابته'],
    goals:['يعد عناصر مجموعة حتى 5','يربط الكمية بالعدد الصحيح','يتعرف الرقم عند سماع اسمه','يميز الصفر بصريًا']
  },
  {
    id:'position-pattern',
    chapter:3,
    ...
    lessons:['فوق وتحت','أعلى وأوسط وأسفل','قبل وبعد','تحديد الأنماط','إنشاء الأنماط'],
  ...
  },
  {
    ...
    shortTitle:'6 إلى 10 • مقارنة وترتيب',
    symbol:'10',
    status:'ready',
    activityTypes:['count-select','spoken-number-select','number-compare','number-order','ordinal-select'],
    lessons:['الأعداد 6،7،8','قراءة الأعداد 6،7،8 وكتابتها','العددان 9،10','قراءة العددين 9،10 وكتابتهما','أحل المسألة: أرسم صورة','مقارنة الأعداد حتى 10','ترتيب الأعداد حتى 10','العدد الترتيبي'],
    goals:['يعد عناصر مجموعة حتى 10','يتعرف الأرقام 6 إلى 10 عند سماعها','يقارن عددين حتى 10','يكمل ترتيبًا عدديًا حتى 10','يميز الموضع الترتيبي']
  },
  {
    id:'numbers-11-20',
    chapter:5,
    title:'الأعداد حتى 20',
    shortTitle:'11 إلى 20 • مقارنة وترتيب',
    symbol:'20',
    status:'ready',
    activityTypes:['count-select','spoken-number-select','number-compare','number-order'],
    lessons:['العددان 11،12','الأعداد 13،14،15','العددان 16،17','أحل المسألة: أبحث عن نمط','الأعداد 18،19،20','مقارنة الأعداد حتى 20','ترتيب الأعداد حتى 20'],
    goals:['يعد عناصر من 11 إلى 20','يتعرف الأعداد حتى 20 عند سماعها','يقارن عددين حتى 20','يكمل ترتيبًا عدديًا ضمن 20']
  },
  {
