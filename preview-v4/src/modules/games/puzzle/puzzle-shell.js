    ...
    <section id="puzzleGameView" class="view">
      <div class="fp-shell">
        <header class="fp-header">
          ...
          <button class="fp-nav" id="fpNew" type="button">خلط من جديد</button>
        </header>
        <div class="fp-layout">
          <aside class="fp-panel" id="fpSetupPanel">
            <section class="fp-control-group"><h3>اختر الصورة</h3><div id="fpPlayers" class="fp-player-list" role="group" aria-label="صور الأطفال"></div></section>
            ...
            <div class="fp-stats"><div><span>القطع المركّبة</span><strong id="fpProgress">٠ / ٩</strong></div><div><span>الوقت</span><strong id="fpTime">٠:٠٠</strong></div></div>
