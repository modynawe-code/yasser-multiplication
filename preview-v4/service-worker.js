...
const CACHE_VERSION=`${CACHE_PREFIX}shell-15`;
const APP_SHELL=[
  ...
  './src/modules/khaled/infrastructure/storage/local-storage-repository.js','./src/modules/khaled/ui/khaled-controller.js',
