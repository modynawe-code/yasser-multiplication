...
const CACHE_VERSION=`${CACHE_PREFIX}shell-52`;
const APP_SHELL=[
  ...
  './src/shared/audio/human-voice-assets.js','./src/shared/audio/human-voice-policy.js','./src/shared/audio/voice-manifest.js','./src/shared/audio/voice-service.js','./src/shared/audio/providers/local-audio-provider.js','./src/shared/audio/providers/native-tts-provider.js','./src/shared/audio/providers/browser-tts-provider.js','./src/shared/audio/speech-service.js','./src/shared/security/parent-access.js','./src/shared/data/attempt-ledger.js','./src/shared/config/family-api-config.js','./src/shared/sync/family-auth-client.js','./src/shared/sync/family-sync-service.js',
