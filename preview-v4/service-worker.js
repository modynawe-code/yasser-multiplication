...
const CACHE_VERSION=`${CACHE_PREFIX}shell-120`;
...
const APP_SHELL=[
  ...
  './src/shared/activities/activity-types.js','./src/shared/activities/activity-contract.js','./src/shared/activities/activity-result.js','./src/shared/activities/activity-renderer-contracts.js',
  ...
  './src/shared/ui/learning-motivation.js','./src/shared/ui/learning-motivation.css','./src/shared/ui/reward-assets.js','./src/shared/ui/reward-cabinet.js','./src/shared/ui/reward-cabinet.css','./src/shared/ui/game-inspired-rewards.js','./src/shared/ui/game-inspired-rewards.css','./src/shared/ui/system-insets.js',
  ...
  './src/modules/games/core/game-contract.js','./src/modules/games/core/game-registry.js','./src/modules/games/core/player-context.js','./src/modules/games/core/game-participant-registry.js','./src/modules/games/core/learning-adapter.js','./src/modules/games/game-catalog.js','./src/modules/games/games-controller.js','./src/modules/games/learning/game-learning-providers.js','./src/modules/games/online/game-room-client.js','./src/modules/games/online/game-room-resume-store.js','./src/modules/games/history/game-history-service.js','./src/modules/games/xo/xo-engine.js','./src/modules/games/xo/xo-online-session.js','./src/modules/games/rps/rps-engine.js','./src/modules/games/rps/rps-graphics.js','./src/modules/games/rps/rps-audio.js','./src/modules/games/rps/rps-controller.js','./src/modules/games/rps/rps-shell.js','./src/modules/games/rps/rps.css','./src/modules/games/rps/rps-open-family.css','./src/modules/games/categories/categories-engine.js','./src/modules/games/categories/categories-controller.js','./src/modules/games/categories/categories-online-controller.js','./src/modules/games/categories/categories-online.css','./src/modules/games/categories/categories.css','./src/modules/games/ui/games-shell.js','./src/modules/games/ui/games.css','./src/modules/games/ui/games-open-family.css',
