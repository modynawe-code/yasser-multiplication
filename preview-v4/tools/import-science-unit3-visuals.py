...
'u3-model-food-web':{'page':163,'box':(1010,940,1880,1600),'alt':'شبكة غذائية في نموذج اختبار تضم أفعى ونسرًا وأسدًا وغزالًا وفأرًا ومنتجات'},
'u3-model-rainforest':{'page':163,'box':(310,1060,880,1570),'alt':'صورة غابة كثيفة الأشجار تستخدم لتحديد المنطقة الحيوية'},
