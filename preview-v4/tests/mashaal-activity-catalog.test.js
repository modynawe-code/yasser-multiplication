...
test('four-domain KG3 starter catalog is fully source-bound and releasable by contract',()=>{
  assert.equal(MASHAAL_KG3_ACTIVITY_CATALOG.length,20);
  ...
  assert.equal(listReleasableMashaalKg3Activities(MASHAAL_KG3_ACTIVITY_CATALOG).length,20);
});
