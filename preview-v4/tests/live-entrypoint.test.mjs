...
test('service worker shell includes open-family runtime and current KG3 activity, parent-report and recitation manifests',async()=>{
  const worker=await readPreview('service-worker.js');assert.match(worker,/shell-43/);
  for(const path of ['ui/styles/character-scale.css','ui/styles/learning-navigation.css','shared/data/attempt-ledger.js','shared/config/family-api-config.js','shared/sync/family-auth-client.js','shared/sync/family-sync-service.js','shared/learners/learner-registry.js','shared/progress/evidence.js','shared/activities/activity-types.js','modules/hub/learner-runtime-registry.js','modules/hub/learner-hub-registry.js','modules/mashaal/curriculum/kg3-activity-catalog.js','modules/mashaal/curriculum/recitation-media-data.js','modules/mashaal/curriculum/recitation-media-manifest.js','modules/mashaal/curriculum/recitation-source-registry.js','modules/mashaal/application/activity-release-validator.js','modules/mashaal/application/activity-completion.js','modules/mashaal/application/transfer-prompts.js','modules/mashaal/application/parent-labels.js','modules/mashaal/application/parent-summary.js','modules/mashaal/ui/activity-view-model.js','modules/mashaal/ui/mashaal-controller.js','modules/mashaal/ui/mashaal.css','modules/khaled/ui/khaled-device-hardening.css','modules/parent/family-parent-controller.js','modules/parent/family-parent-renderers.js','modules/parent/family-parent-shell-registry.js'])assert.match(worker,new RegExp(escapeRegExp(path)));
