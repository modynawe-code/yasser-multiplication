...
test('service worker shell is current for chapter-one activity visuals',async()=>{
  const worker=await readPreview('service-worker.js');
  assert.match(worker,/shell-17/);
  for(const path of ['shared/security/parent-access.js','modules/khaled/ui/khaled-scene-controller.js','modules/khaled/ui/khaled-character-system.css','modules/khaled/ui/khaled-activity-types.css','modules/parent/family-parent-controller.js','modules/parent/family-parent-renderers.js','modules/parent/family-parent.css']){
