...
test('service worker shell includes open-family runtime and current KG3 activity and parent-report shell',async()=>{
  const worker=await readPreview('service-worker.js');assert.match(worker,/shell-42/);
